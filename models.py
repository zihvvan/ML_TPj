...
def show_user_interface(model_num):
    ...
    나이 = r1_col1.slider("나이", 20, 70, key="age")
    ...
    워라벨 = r3_col4.slider('워라벨', 1, 4, key="work_life_balance")

    성별 = st.selectbox('성별', ('남자', '여자'), key="gender")

    predict_button = st.button("퇴사유무 예측", key="prediction")
