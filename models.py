...
def show_user_interface(model_num):
    ...
    # 첫번째 행
    r1_col1, r1_col2, r1_col3, r1_col4  = st.columns(4, key="col1")
    ...
    # 두번째 행
    r2_col1, r2_col2, r2_col3, r2_col4 = st.columns(4, key="col2")
    ...
    # 세번째 행
    r3_col1, r3_col2, r3_col3, r3_col4 = st.columns(4, key="col3")
